...
import { cn } from "@/shared/lib/utils" // Note: updated path alias for consistency
...
function SheetContent({
  ...
  children,
  side = "right",
  showCloseButton = true, // <-- ADDED: Default to true for backward compatibility
  ...props
}: React.ComponentProps<typeof SheetPrimitive.Content> & {
  side?: "top" | "right" | "bottom" | "left",
  showCloseButton?: boolean, // <-- ADDED: Prop definition
}) {
  return (
    <SheetPortal>
      <SheetOverlay />
      ...
      >
        {children}
        {/* --- MODIFIED: Conditionally render the close button --- */}
        {showCloseButton && (
